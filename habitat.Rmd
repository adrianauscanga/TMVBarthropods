...
title("a) Curculionidae (Coleoptera)", adj=0, cex=1.5)
```

Repeat with the other trees:

Carabideae
```{r, echo=FALSE, results= "hide", fig.width=12, fig.height=9}
...
tiplabels(pch=15, col=as.vector(samtips), adj=0, offset=0.51, cex=1.5)
tiplabels(text=nomtips, frame="none", col="black", cex=1, adj=0, offset = 0.018)
title("b) Carabidae (Coleoptera)", adj=0, cex=1.5)
```


Linyphiidae
```{r, echo=FALSE, results= "hide", fig.width=12, fig.height=24}
...
tiplabels(pch=15, col=as.vector(samtips), adj=0, offset=0.51, cex=1.5)
tiplabels(text=nomtips, frame="none", col="black", cex=1, adj=0, offset = 0.018)
title("c) Linyphiidae (Aranae)", adj=0, cex=1.5)
```


Gnaphosidae
```{r, echo=FALSE, results= "hide", fig.width=12, fig.height=5}
...
tiplabels(pch=15, col=as.vector(samtips), adj=0, offset=0.51, cex=1.5)
tiplabels(text=nomtips, frame="none", col="black", cex=1, adj=0, offset = 0.018)
title("d) Gnaphosidae (Aranae)", adj=0, cex=1.5)
```
