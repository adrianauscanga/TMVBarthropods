...
levels(samtips)<-c("darkolivegreen3", "orange")
samtips
...
Bar plots OTU abundance
```{r}
# Before doing this Alicia whants to know how the bar plot of OTUs abundance/ habitat was done.
```
