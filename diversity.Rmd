...
```{r}
OTU40<-read.dna("OTU40.fasta", format="fasta")
...
Repeat with other OTUs | Se repite con las otras OTUs
...
OTUs<-OTUs[1:45,2:8] #Quitamos la columna de OTU porque es repetitiva
View(OTUs)
```
