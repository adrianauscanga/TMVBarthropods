...
```{r}
CurcuTtree<-read.nexus("CurculionidaeTtree")
```
...
To change the branches namesPara cambiar la fuente de los nombres de las ramas se modifica la función (plotCluster3)
```{r}
...
Repeat this with each taxonomic family | Se repite con cada familia taxonómica
